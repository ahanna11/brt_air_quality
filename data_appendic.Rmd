...
```{r insert BRT data for  4 cities}
...
#https://onlinelibrary.wiley.com/doi/pdf/10.1002/atr.5670370202 


```


```{r custom BRT data table}

brt_data_all_cities <- read_delim("brt_data_all_cities.csv", 
    ";", escape_double = FALSE, col_types = cols(Indicator = col_skip()), 
    na = "null", trim_ws = TRUE)
# Created from BRT source data in Numbers
